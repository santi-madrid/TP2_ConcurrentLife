...
// ! Comparado al otro grupo, este monitor tiene menos abstraccion y no es escalable/modular
// Abstraccion/acoplamiento: aca se maneja TODO dentro del monitor, en cambio en el otro grupo lo
// encapsulan en la clase Cola. Monitor mezcla sincronización, política, métricas y estructura de
// espera.
// Modular: aca se repite codigo, es mas propenso a errores y hay que hacer cambios manuales en
// muchos lugares
// ! Ambos factores hacen que sea menos legible

// ! No estan haciendo que el fairness del semaphoro sea true, lo que puede generar inanicion

// ! Para detectar "quien espera", se infiere esperando con getQueueLength() de cada semáforo; esto
// ! puede ser más frágil frente a carreras y no siempre representa exactamente “quién debería ser
// ! elegible”.

...
// * Esta bien, sigo pensando que el uso de ThreadFactory no es necesario
// ! No hay un join para esperar a que los hilos terminen
...
public class Main {
  public static void main(String[] args) {
    ...
    for (int i = 0; i < 2; i++) {
      thread =
          factory.newThread(new Agent(sharedMonitor, sharedCounter1, i)); // tambien tarea del hilo
      thread.start();
    }
